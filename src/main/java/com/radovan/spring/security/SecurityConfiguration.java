...
public class SecurityConfiguration  {
	...
	protected SecurityFilterChain configure(HttpSecurity http) throws Exception {
		...
		http.authorizeHttpRequests(authorize -> authorize
				.requestMatchers("/login","/loginErrorPage").anonymous()
				.requestMatchers("/registerComplete", "/registerFail","/register").anonymous()
				.requestMatchers("/loginPassConfirm","/","/home","/contactInfo").permitAll()
